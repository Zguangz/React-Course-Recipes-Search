...
export default class RecipeDetails extends Component {
    ...
    //     this.state = {
    //         recipe: recipe,
    //         url:`https://www.food2fork.com/api/get?key=e5b4c4ffb6234d90cd26734e175fdf06&rId=${this.props.id}`,
    //     }
    // }
    ...
    /* Can access this. props through componentDidMount*/
    async componentDidMount() {
        const id = this.props.id
        const url = `https://www.food2fork.com/api/get?key=e5b4c4ffb6234d90cd26734e175fdf06&rId=${id}`
        // try {
